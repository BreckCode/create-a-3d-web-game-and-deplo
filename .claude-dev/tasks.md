...
- [x] 21. Build, deploy to Netlify, and verify | Run production build, deploy to Netlify via CLI, verify the live URL works correctly | files: netlify.toml, package.json
